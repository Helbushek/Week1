@include ('blocks.header', ['title'=>"Add review"])
...
<main class="form-signin w-25 m-auto">
  <form method="GET" action="/review/_add">
  ...
  @endif
    <div class="form-floating mb-3">
        <input type="text" class="form-control" id="text" required name="text"  placeholder="Review">
  ...
  <div>
    ...
    <button class="btn btn-primary w-100 py-2" name="id" value="{{$id}}" type="submit">Add</button>
  </form>
</main>
